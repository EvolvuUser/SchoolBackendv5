...
<head>
  ...
  <style type = "text/css">
    ...
    padding: 0;
        ...
        body{
    background-image: url('https://sms.evolvu.in/public/reportcard/SACS/LKG_bg.jpg');
...
<div class="col-md-2"></div>
	<div class="col-md-8  table-responsive bgimg" style="text-align:center;">
        ...
        <table class="table-responsive" style="width:80%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;margin-top: 1%;" cellpadding="0" cellspacing="0">
			 <tr>
					...
					<table class="" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
						...
						<tbody>
							...
							foreach($sub_list as $rw){?>
							 ...
							 <?php  //$exam_list	=	$this->assessment_model->get_exams($acd_yr);
								foreach($term_list as $term){						
									$exam_list	=	get_exams_by_class_per_term($row1['class_id'],$term->term_id,$row1['academic_yr']);
									foreach($exam_list as $exam){?>
										...
										//$mark_headings = $this->assessment_model->get_marks_headings_name_by_class_and_subject($row1['class_id'],$rw['sub_rc_master_id'],$acd_yr);
										...
										if(count(${'mark_obtained_array_'.$exam->exam_id}) == 1){
											foreach(${'mark_obtained_array_'.$exam->exam_id} as $key => $value) { 
												...
												$highest_mark_of_a_markheading=${'highest_marks_array_'.$exam->exam_id}[$key] ?? 0; //30-09-22
													...
													<?php
														if($value=='Ab'){
															...
															if($value<>""){
																...
																$grade = get_grade_based_on_marks($value_per_100,$rw->subject_type,$row1['class_id']); //Lija for report card$value;  //Lija 30-09-22
																echo $grade."<br/>";
															}else{
																echo "<br/>";
															}
									...
									<?php 
										if($marks_obtained=='Ab'){
											...
											if($marks_obtained<>""){
												...
												$grade = get_grade_based_on_marks($value_per_100,$rw->subject_type,$row1['class_id']); //Lija 30-09-22
		...
		<table class="table-responsive" border="0" style="width:80%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;margin-top: 1%;" cellpadding="0" cellspacing="0">
			 <tr>
				 <td style="vertical-align:center;border-top:2px solid black;border-left:2px solid black;border-right:2px solid black;border-bottom:2px solid black" cellpadding="0" cellspacing="0">
				 <?php
					...
					<table class="table-responsive" style="width:95%;margin-top:1%;margin-left:4%;margin-right: 4%;border-spacing: 0px;background-color:white;" cellpadding="1" cellspacing="10">
						<tr>
							<td style="width:30%;">
								<table class="table-responsive" width="100%" cellspacing="0">
									<tr>
										<th class="bottomth" width="15%" ><br/>Term 1 <br/></th>
										<td class="termsigntd"></td>
									</tr>
									 <tr>
										<th class="bottomth" width="15%"><br/> Term 2<br/></th>
										<td class="termsigntd"></td>
									</tr>
								</table>
							</td>
						...
						<tr> 
							<td style="width:30%;">
								<table class="table-responsive" width="100%" cellspacing="0">
									<tr>
										<th class="bottomth" width="15%" ></th>
										<td class="signtd"><b>Class Teacher's Sign.</b></td>
									</tr>
								</table>
							</td>
							<td style="width:30%;">
								<table class="table-responsive" width="100%" cellspacing="0">
									<tr>
										<th class="bottomth" width="15%" ></th>
										<td class="signtd"><b>Parent's Sign.</b></td>
									</tr>
								</table>
							</td>
							<td style="width:30%;">
								<table class="table-responsive" width="100%" cellspacing="0">
									<tr>
										<th class="bottomth" width="15%" ></th>
										<td class="signtd"><b>Principal's Sign.</b></td>
									</tr>
								</table>
							</td>
						</tr>
