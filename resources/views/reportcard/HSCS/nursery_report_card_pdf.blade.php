...
<html>
    ...
    <div class="col-md-12 pdfdiv bgimg">
		...
		<div class="col-md-8 table-responsive " style="text-align:center;">
			<table border="0" style="width:680x;margin-left:37%;margin-right: auto;border-spacing: 0px;background-color:rgba(0, 0, 0, 0);margin-top: 18%;">
				<tr>
	...
	<!--				    UDISE No. - 27250504625-->
			...
			<table border="0" class="table-responsive" style="table-layout:fixed;width:680px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:white;margin-top:2%;border:1px solid grey;padding:1%;" cellpadding="2" cellspacing="10">
				<tr> 
	...
	<div class="col-md-12 pdfdiv bgimg1">
		<div class="col-md-2"></div>
		<div class="col-md-8 table-responsive " style="text-align:center;">
			 <table class="table-responsive" style="width:680px;margin-left:7%; margin-right: auto; border-spacing: 0px; background-color:white; margin-top: 10%;border:1px solid black;" cellpadding="0" cellspacing="0" >
				<?php
				...
				foreach ($domain_p as $r):
					...
					<tr>
						<!--<td></td>-->
						<th class="th" style="font-size:14px;padding:2px;width:25%;"><b><?php echo $r->name; ?></b><br><?php echo $r->curriculum_goal; ?></th>
					...
					foreach ($parameters as $p):
						?>
							<tr>
								<td class="td" style="word-wrap:normal;font-size:14px;padding:2px;"><?php echo $p->learning_outcomes; ?></td>
    ...
    <div class="col-md-12 pdfdiv bgimg1">
	    ...
	    <h3 style="margin-right: 50%;margin-top:10%;">Peer Feedback from Classmate(s)</h3>
        ...
        <h3 style="margin-right: 67%;">Self Assessment</h3>
		...
		<br>
		<table class="table-responsive" style="width:90%;margin-left: 6%;margin-right: auto;border-spacing: 0px;background-color:white;border: 0px solid red">
		...
		<br/>
		<table class="table-responsive" style="width:85%;margin-left: 6%;margin-right: auto;border-spacing: 0px;background-color:white;border: 0;margin-top:5%;" cellpadding="1" cellspacing="10">
			<tr>
				<td style="width:33%;">
