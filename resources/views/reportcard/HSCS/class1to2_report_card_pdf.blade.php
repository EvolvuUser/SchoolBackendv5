...
<div class="col-md-2"></div>
	<div class="col-md-8 table-responsive " style="text-align:center;">
		<table border="0" style="width:750px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:rgba(0, 0, 0, 0);margin-top: 11%;">
			<tr>
...
<!--				    UDISE No. - 27250504625-->
	 ...
	 <br>
		<table border="0"  class="table-responsive" style="table-layout:fixed;width:750px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:white;margin-top:3%;border:1px solid grey;padding:1%;" cellpadding="2" cellspacing="10">
			<tr> 
...
-->
     ...
     <br><br>
        ...
        <table class="table-responsive" style="width:750px;margin-left:7%;margin-right: auto;border-spacing: 0px;margin-top: 7%;border:0;margin-top: 22%;" cellpadding="0" cellspacing="0" >
					<tr>
						...
						<th style="height:250px;width:70%;border: 1px solid grey;border-radius: 5px;padding:2%;" align="center" valign="middle">
    					    <img src="{{ rtrim(app('global_variables')['codeigniter_app_url'], '/') }}/uploads/student_image/{{ $row1['image_name'] }}" width="auto" height="200px" style="text-align:center;"> 
    					</th>
					</tr>
					<tr>
						<th style=""></th>
...
<div class="col-md-2"></div>
	<div class="col-md-8 table-responsive " style="text-align:center;">
	     <table class="table-responsive" style="width:95%; margin-left: 5%; margin-right: auto; border-spacing: 0px; background-color:white; margin-top: 3%;" cellpadding="0" cellspacing="0" >
						...
						foreach($term as $row): 
						    ${'reportcard_publish_term'.$row['term_id'].'_value'}=$this->assessment_model->get_reportcard_publish_value($row1['class_id'],$row1['section_id'],$row['term_id']);//report card publish value for each term 
						?>
						...
						<tr>
						    <th class="td"></th>
                            <?php 
                            //$term	=	$this->assessment_model->peer_assessment_parameter($row1['class_id']);
                            $term	=	$this->assessment_model->get_term();
                            foreach($term as $row):
                            //if($row['name']!='Term 2'){ ?>
                ...
                endforeach;?>
						...
						foreach($domain_p as $r){?>
						    <tr>
						        ...
						        <?php $parameters = $this->assessment_model->get_parameter_by_dm_id($r['dm_id']);
						    ...
						    <tr>
                                ...
                                <?php 
                                foreach($term as $row){
                                    $parameter_value= $this->assessment_model->get_published_domain_parameter_value_by_id($row1['student_id'],$p['parameter_id'],$row['term_id'],$this->session->userdata['acd_yr']);
            
                                ?>
                                <td class="td" style="vertical-align:center;text-align:center;"><?php if($parameter_value=='Beginner' && ${'reportcard_publish_term'.$row['term_id'].'_value'}=='Y'){ ?><img height="10px" width="12px" src="<?php echo base_url();?>uploads/check.jpg" alt="Checkmark"> <?php } ?></td>
                                        <td class="td" style="vertical-align:center;text-align:center;"><?php if($parameter_value=='Progressing'  && ${'reportcard_publish_term'.$row['term_id'].'_value'}){ ?><img height="10px" width="12px" src="<?php echo base_url();?>uploads/check.jpg" alt="Checkmark"> <?php } ?></td>
                                        <td class="td" style="vertical-align:center;text-align:center;"><?php if($parameter_value=='Proficient'  && ${'reportcard_publish_term'.$row['term_id'].'_value'}){ ?><img height="10px" width="12px" src="<?php echo base_url();?>uploads/check.jpg" alt="Checkmark"> <?php } ?></td>
                                  <?php }?>
						    </tr>
        ...
        <div class="col-md-12 pdfdiv bgimg1">
					...
					<table class="table-responsive" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
						...
						//	$count_of_mark_headings=0;
							foreach($term_list as $term){
								...
								//$count_of_mark_headings=0;
								$exam_list	=	$this->assessment_model->get_exams_by_class_per_term($row1['class_id'],$term['term_id'],$acd_yr);
								foreach($exam_list as $exam){
									${'count_of_mark_headings_'.$exam['exam_id']}=0;
									$marks_headings = $this->assessment_model->get_marks_heading_class($row1['class_id'],1,$exam['exam_id'],$acd_yr);
						...
						$sub_list = $this->assessment_model->get_scholastic_subject_alloted_to_class($row1['class_id'],$acd_yr);
						...
						<tr>
							...
							foreach($term_list as $term){
								...
								foreach($exam_list as $exam){
									${'marks_resultarray_'.$term['term_id']}	=	$this->assessment_model->get_marks($exam['exam_id'],$row1['class_id'],$row1['section_id'],$sub_row['sub_rc_master_id'],$student_id,$acd_yr);
						...
						<td class="col-md-1 scholastictd"  style="vertical-align:middle;text-align:center;height:30px;"><?php echo number_format($total_marks_obtained,1);?></td>
						...
						<?php
							...
							if($total_marks_obtained==""){
								...
								if($total_highest_marks<>0){
									...
									$final_grade = $this->assessment_model->get_grade_based_on_marks(number_format($total_marks_obtained),'Scholastic',$row1['class_id']); 
								}
			...
			<br>
			<table class="table-responsive"style="table-layout:fixed;width:750px;margin-left: 6%;margin-right: auto;border-spacing: 0px;background-color:white;margin-top:30%;">
				<tr>
                                ...
                                <table class="table-responsive " style="width:100%; margin-left: auto; margin-right: auto; border-spacing: 0px; background-color:white;" cellpadding="0" cellspacing="0">
                                 ...
                                 //foreach($term_list as $term){
                                    ...
                                    foreach($term_list as $term){
                                        ...
                                        ${'marks_resultarray_'.$term['term_id']}	=	$this->assessment_model->get_marks($exam['exam_id'],$row1['class_id'],$row1['section_id'],$sub_row['sub_rc_master_id'],$row1['student_id'],$row1['academic_yr']);
                    					...
                    					if(isset(${'marks_resultarray_'.$term['term_id']}[0])){
                    						...
                    						if(isset(${'mark_obtained_array_'.$term['term_id']}) && ${'mark_obtained_array_'.$term['term_id']}<>null){
                    							...
                    							if($coscholastic_grade=="Ab" && ${'coscholastic_marksobtained_'.$term['term_id']}==0){
                    								...
                    								$coscholastic_grade= $this->assessment_model->get_grade_based_on_marks(number_format($marks_per_50),'Co-Scholastic',$row1['class_id']); 
    ...
    <!--    		    </table>-->
			...
			<h3 style="margin-right: 70%;margin-top:auto;text-align:center;margin-top:48%;">Parent's Feedback</h3>
		...
		<h3 style="margin-right: 72%;margin-top:20%;text-align:center;">Peer Assessment</h3>
			 ...
			 <tr>
				 <td style="valign:top;inline-block;margin:0;padding:0;" cellpadding="0" cellspacing="0" class="term">
					<table class="" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
                        ...
                        <?php 
                            $pa	=	$this->assessment_model->peer_assessment_parameter($row1['class_id']);
                            foreach($pa as $r):
                            ...
                            <tr>
                                 ...
                                 <?php 
                                  $term	=	$this->assessment_model->get_term();
                                 foreach($term as $row): 
                                 $pa = $this->assessment_model->get_published_peer_assessment_parameter_value_by_id($row1['student_id'],$r['pam_id'],$row['term_id'],$acd_yr);
                                 ?>
        ...
        <br>
		<h3 style="margin-right: 75%;margin-top:29%;">Health Status</h3>
      	<table class="table-responsive scholastictable" style="width:94%;margin-left: 6%;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
			<tr> 
        ...
        <br>
         <h3 style="margin-right: 75%;margin-top:12%;">Attendance</h3>
        <table class="table-responsive scholastictable" style="width:94%;margin-left:6%;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0" >
			<tr> 
            ...
            <tr>
                ...
                <td class="td"  style="text-align: center;">
				    <?php
						if(${'reportcard_publish_term'.$row['term_id'].'_value'}=='Y'){
							echo $this->crud_model->get_total_workingdays_from_dailyattendance_classwise($row1['class_id'],$row1['section_id'],$date_from,$date_to,$acd_yr);
						}
					?>
				</td> 
                <?php
				...
				?>
					<td class="td"  style="text-align: center;">
				        <?php
        					...
        					if($this->crud_model->get_total_stu_attendance_till_a_month($row1['student_id'],$date_from,$date_to,$acd_yr)<>"" && ${'reportcard_publish_term'.$row['term_id'].'_value'}=='Y'){
        						echo $this->crud_model->get_total_stu_attendance_till_a_month($row1['student_id'],$date_from,$date_to,$acd_yr);
        					}
        				?>
