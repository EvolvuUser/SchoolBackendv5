...
<!--				    UDISE No. - 27250504625-->
	 ...
	 <br>
				...
				<table class="table-responsive" style="width:750px;margin-left:7%;margin-right: auto;border-spacing: 0px;margin-top: 7%;border:0;" cellpadding="0" cellspacing="0" >
					...
					<tr>
						...
						<th style="height:350px;width:70%;border: 1px solid grey;border-radius: 5px;padding:2%;" align="center" valign="middle">
    					    <img src="<?php echo base_url(); ?>/uploads/family_image/<?php echo $parent_info[0]['family_image_name']; ?>" width="400px" height="auto" style="text-align:center;"> 
    					</th>
					</tr>
				</table>
			</div>
        ...
        <div class="col-md-12 pdfdiv bgimg1">
			...
			<div class="col-md-8 table-responsive " style="text-align:center;">
				...
				<table class="table-responsive"style="table-layout:fixed;width:750px;margin-left: 7%;margin-right: auto;border-spacing: 0px;background-color:white;margin-top:7%;">
				<tr>
                    ...
                    foreach ($domain_p as $r):
                        ?>
						    ...
						    <tr>
                                ...
                                ?>
                                <td class="td" ><?php if ($parameter_value == 'Beginner') { ?><img height="30px" width="30px" src="<?php echo base_url(); ?>uploads/begg.jpg" alt="Checkmark"> <?php } ?></td>
                                <td class="td" ><?php if ($parameter_value == 'Progressing') { ?><img height="30px" width="30px" src="<?php echo base_url(); ?>uploads/prog.jpg" alt="Checkmark"> <?php } ?></td>
                                <td class="td" ><?php if ($parameter_value == 'Proficient') { ?><img height="30px" width="30px" src="<?php echo base_url(); ?>uploads/prof.jpg" alt="Checkmark"> <?php } ?></td>
                                <td class="td" ><?php if ($parameter_value == 'Advance') { ?><img height="30px" width="30px" src="<?php echo base_url(); ?>uploads/adv.jpg" alt="Checkmark"> <?php } ?></td>
						    </tr>
				...
				<table class="table-responsive" style="width:750px;margin-left:7%; margin-right: auto; border-spacing: 0px; margin-top: 41%;" cellpadding="0" cellspacing="0" >
				 <tr>
					 <td style="width:100%;vertical-align:middle;text-align: center;" cellpadding="0" cellspacing="0">
						<table border="0" class="table-responsive" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
						   <tr>
								<?php
                                $term_list = $this->assessment_model->get_published_terms($row1['class_id'], $row1['section_id']);
    ...
    <!--    		    </table>-->
        ...
        <h3 style="margin-right: 67%; margin-top:6%;">Self Assessment</h3>
        
        <table class="table-responsive" style="width:94%;margin-left: 6%;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
			 <tr>
		...
		<h3 style="margin-right: 50%;margin-top:28%;">Peer Feedback from Classmate(s)</h3>
		...
		<br>
        <h3 style="margin-right: 67%; margin-top:13%;">Parent's Feedback</h3>
		...
		<br>
		<table class="table-responsive" style="width:750px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:white;margin-top:14%;border: 0px solid red">
		...
		<br/>
		<table class="table-responsive" style="width:750px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:white;border: 1px;margin-top:22%;" cellpadding="1" cellspacing="10">
			<tr>
				<td style="width:33%;">
