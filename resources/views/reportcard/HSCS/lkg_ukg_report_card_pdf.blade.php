...
<style type = "text/css">
  ...
  .bgimg {
    background-image: url('https://sms.evolvu.in/public/reportcard/HSCS/kg_new.jpg');
...
.bgimg1 {
    background-image: url('https://sms.evolvu.in/public/reportcard/HSCS/kg_BLANK.jpg');
   -webkit-background-size: cover;
    -moz-background-size: cover;
    -o-background-size: cover;
    background-size: cover;
...
<div class="col-md-2"></div>
	<div class="col-md-8 table-responsive " style="text-align:center;">
		<table border="0" style="width:680px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:rgba(0, 0, 0, 0);margin-top: 18%;">
			<tr>
...
<!--				    UDISE No. - 27250504625-->
		...
		<br>
        	<table border="0"  class="table-responsive" style="table-layout:fixed;width:680px;margin-left:9%;margin-right: auto;border-spacing: 0px;background-color:white;margin-top: 1%;" cellpadding="1" cellspacing="10">
			<tr> 
                <td style="height:50px;width:12%;border: 1px solid grey;border-radius: 5px;">
            <!--<img height="20%" width="50%" src="https://holyspiritconvent.evolvu.in/test/hscs_test/uploads/3053.jpg">-->
		</td>
 
             <td style="padding:2%;margin-left:12%;width:40%;text-color:black;">   <h4 style="color: black;">A 360 View of (<?php echo $row1['first_name'] . ' ' . $row1['mid_name'] . ' ' . $row1['last_name']; ?>)</h4><p style="color: black;">(A child should not be judged only his/her academic performance. Love the child for what he/she is, not for how much he/she scores)</p></td>
             </tr>
	 </table>
	 <br>
		<table border="0"  class="table-responsive" style="table-layout:fixed;width:680px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:white;border:1px solid grey;padding:1%;" cellpadding="2" cellspacing="10">
			<tr> 
                ...
                <td style="width:100%;text-align: left;">
                    <table border="0" class="table-responsive" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
                      <td style="width: 20%;font-size:14px;padding-top: 8px; padding-bottom:8px;	word-wrap:break-word;">ADMISSION NO. </td>
                        ...
                        <td style="font-size:14px;width:15%;padding-top: 8px; padding-bottom:8px;	word-wrap:break-word;">AADHAR NO </td>
		...
		<br>
		<h3 style="margin-right: 69%;">All About Me</h3>
			
			<table class="table-responsive" style="width:680px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0" >
				<?php
                $allaboutme_master = get_studentaboutme_master_by_class_id($row1['class_id']);
                foreach ($allaboutme_master as $aam_r):
                    $allaboutme_value = get_allaboutme_for_student($row1['student_id'], $aam_r->am_id, $academic_yr);
                    ?>
    				    <tr>
                            <td  class="atd" width="30%" ><?php echo $aam_r->name; ?></td>
                            <td  class="atd" width="70%"><?php echo isset($allaboutme_value[0]->aboutme_value) ? $allaboutme_value[0]->aboutme_value : ''; ?>
                            </td>
                        </tr> 
            <?php endforeach; ?>
			</table>
			...
			<table class="table-responsive" style="width:680px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0" >
				<tr> 
					<?php
                    $reportcard_publish_term1_value = get_reportcard_publish_value_for_exam($row1['class_id'], $row1['section_id'], 'Term I');  // report card publish value for Term I exam
                    $reportcard_publish_term2_value = get_reportcard_publish_value_for_exam($row1['class_id'], $row1['section_id'], 'Term II');  // report card publish value for Term II exam
				...
				<tr> 
					...
					<td class=""  style="font-size:14px;valign:top;inline-block;width:10%;border-bottom:1px solid grey;"> <div class="statistics_line"><?php echo $row1['height']; ?></div></td> 
				...
				<tr> 
					...
					<td style="font-size:14px;valign:top;inline-block;width:10%;border-bottom:1px solid grey;"> <div class="statistics_line"><?php echo $row1['weight']; ?></div></td> 
        ...
        <div class="col-md-12 pdfdiv bgimg1">
			<div class="col-md-2"></div>
        	<div class="col-md-8 table-responsive " style="text-align:center;">
				<table class="table-responsive" style="width:680px;margin-left:7%;margin-right: auto;border-spacing: 0px;margin-top: 10%;border:0;" cellpadding="0" cellspacing="0" >
					<tr>
					...
					<tr>
						...
						<th style="height:350px;width:70%;border: 1px solid grey;border-radius: 5px;padding:2%;" align="center" valign="middle">
    					    <img src="{{ $codeigniter_app_url }}/uploads/family_image/<?php echo $parent_info[0]->family_image_name; ?>" width="400px" height="auto" style="text-align:center;"> 
    					</th>
					</tr>
				</table>
			</div>
        ...
        <div class="col-md-12 pdfdiv bgimg1">
			<div class="col-md-2"></div>
			<div class="col-md-8 table-responsive " style="text-align:center;">
				<!--table class="table-responsive" style="width:750px;margin-left:7%; margin-right: auto; border-spacing: 0px; background-color:white; margin-top: 7%;" cellpadding="0" cellspacing="0" -->
				<table class="table-responsive"style="table-layout:fixed;width:680px;margin-left: 7%;margin-right: auto;border-spacing: 0px;background-color:white;margin-top:10%;">
				<tr>
                    ...
                    foreach ($domain_p as $r):
                        ?>
						    <tr>
                                ...
                                <th class="th" style="text-align:center;padding:2px;width:10%;">Advance</th>
						    </tr>
						    ...
						    <tr>
                                ...
                                echo ('-----------------------');
                                // foreach($term as $row):
                                $parameter_value = get_published_domain_parameter_value_by_id($row1['student_id'], $p->parameter_id, '2', $academic_yr);
                                // print_r($parameter_value);
                                // $parameter_value='Beginner';

                                ?>
                                <td class="td" ><?php if ($parameter_value == 'Beginner') { ?><img height="30px" width="30px" src="{{ $codeigniter_app_url }}/uploads/begg.jpg" alt="Checkmark"> <?php } ?></td>
                                <td class="td" ><?php if ($parameter_value == 'Progressing') { ?><img height="30px" width="30px" src="{{ $codeigniter_app_url }}/uploads/prog.jpg" alt="Checkmark"> <?php } ?></td>
                                <td class="td" ><?php if ($parameter_value == 'Proficient') { ?><img height="30px" width="30px" src="{{ $codeigniter_app_url }}/uploads/prof.jpg" alt="Checkmark"> <?php } ?></td>
                                <td class="td" ><?php if ($parameter_value == 'Advance') { ?><img height="30px" width="30px" src="{{ $codeigniter_app_url }}/uploads/adv.jpg" alt="Checkmark"> <?php } ?></td>
						    </tr>
				...
				<table class="table-responsive" style="width:680px;margin-left:7%; margin-right: auto; border-spacing: 0px;" cellpadding="0" cellspacing="0" >
				 <tr>
					 <td style="width:100%;vertical-align:middle;text-align: center;" cellpadding="0" cellspacing="0">
						<table border="0" class="table-responsive" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
						   <tr>
                                ...
                                $exam_list = get_published_exams_of_a_class($row1['class_id'], $row1['section_id'], $row1['academic_yr']);
                                // print_r($term_list);

                                $colspan_for_scholastic = 0;
                                foreach ($exam_list as $exam) {
                                    ${'marks_headings_' . $exam->exam_id} = get_marks_heading_class($row1['class_id'], 1, $exam->exam_id, $row1['academic_yr']);
							...
							<tr>
                                ...
                                foreach ($exam_list as $exam) {
                                    ...
                                    ?> 
											<th class="scholastictd" colspan="<?php echo count(${'marks_headings_' . $exam->exam_id}); ?>" style="vertical-align:middle;text-align:center;"><?php echo $exam_name; ?></th>
								 <?php
                                }
                                ?>
									<th class="scholastictd" style="" colspan="2"></th>
							...
							<tr>
                                ...
                                foreach ($exam_list as $exam) {
                                    ...
                                    foreach (${'marks_headings_' . $exam->exam_id} as $mrow) {
                                        ...
                                        ?>
								 <th class="scholastictd" style="text-align:center;white-space:nowrap;" ><?php echo $mrow->marks_headings_name . '<br/>(' . $mrow->highest_marks . ')' ?></th>
							 <?php
                                    }
                                }
                                ?>
								<th class=" scholastictd" style="" >Total<?php echo '<br/>(' . $total_highest_marks_for_heading . ')'; ?></th>	
								<th class=" scholastictd" style="" >Grade</th>	
							</tr>		
                            ...
                            foreach ($sub_list as $sub_row) {
                                ...
                                ?>
							<tr>
								 <td  class="col-md-1 col-sm-1 col-xs-1 scholastictd subnamesize" style="vertical-align:middle;text-align:center;"> 
									<?php
                                    echo $sub_row->name;
                                    ?>
								</td>
                                ...
                                if (isset($exam_list) && count($exam_list) > 0) {
                                        ...
                                        if (isset(${'marks_resultarray_' . $exam->exam_id}[0])) {
                                            ...
                                            if (isset(${'mark_obtained_array_' . $exam->exam_id}) && ${'mark_obtained_array_' . $exam->exam_id} <> null) {
                                                foreach (${'mark_obtained_array_' . $exam->exam_id} as $key => $value) {
                                                    ...
                                                    ?> 
													<td class="col-md-1 col-sm-1 col-xs-1 scholastictd" style="vertical-align:middle;text-align:center;"><?php echo $value; ?></td>
											<?php
                                                }
                                                // Lija 18-03-22
									...
									<?php } else { ?>
													<td class="col-md-1 col-sm-1 col-xs-1 scholastictd" colspan="<?php echo (${'count_of_mark_headings_' . $exam->exam_id} + 2); ?>" style="vertical-align:middle;text-align:center;"></td> 
									<?php
                                            }
                                        } else {
                                            for ($i = 0; $i < ${'count_of_mark_headings_' . $exam->exam_id}; $i++) {
                                    ?>
										<td class="col-md-1 col-sm-1 col-xs-1 scholastictd" style="vertical-align:middle;text-align:center;"></td>
								<?php
                                            }
                                        }
                                    }
                                    ?>
							<td class="col-md-1 col-sm-1 col-xs-1 scholastictd"  style="vertical-align:middle;text-align:center;"><?php
                                    if ($total_marks_obtained <> '') {
                                        echo number_format($total_marks_obtained, 1);
                                    }
                                    ?></td>
										
							<td class="col-md-1 col-sm-1 col-xs-1 scholastictd"  style="vertical-align:middle;text-align:center;">
							<?php
                            if ($total_marks_obtained <> '') {
                            ...
                            if ($total_marks_obtained == '') {
                                ...
                                if ($total_highest_marks <> 0) {
                                    ...
                                    $final_grade = get_grade_based_on_marks(number_format($subject_total_marks_per_100), 'Scholastic', $row1['class_id']);
                                }
			...
			<br>
			<br>
			<table class="table-responsive"style="table-layout:fixed;width:680px;margin-left: 7%;margin-right: auto;border-spacing: 0px;background-color:white;">
				<tr>
                    <td style="vertical-align:top;width:50%">
                        <table class="table-responsive" style="border:0px;width:100%" cellpadding="0" cellspacing="0">
                            <tr>
								...
								<?php
                                $exam_list = get_exam_for_which_marks_available($row1['class_id'], $row1['section_id'], $row1['student_id'], 'Co-Scholastic');
            ...
            if (isset(${'marks_resultarray_' . $exam->exam_id}[0])) {
                ...
                if (isset(${'mark_obtained_array_' . $exam->exam_id}) && ${'mark_obtained_array_' . $exam->exam_id} <> null) {
                    ...
                    if ($coscholastic_grade == 'Ab' && ${'coscholastic_marksobtained_' . $exam->exam_id} == 0) {
                        ...
                        $coscholastic_grade = get_grade_based_on_marks(number_format(${'coscholastic_marksobtained_' . $exam->exam_id}), 'Co-Scholastic', $row1['class_id']);
                    }
                }
            } else {
                $coscholastic_grade = '';
    ...
    <!--    		    </table>-->
        ...
        <h3 style="margin-right: 67%;margin-top:10%;">Self Assessment</h3>
        
        <table class="table-responsive" style="width:82%;margin-left: 6%;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
			 <tr>
                 <td style="valign:top;inline-block;margin:0;padding:0;width:100%" cellpadding="0" cellspacing="0" class="term">
					<table class="" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
                        ...
                        foreach ($pa as $r):
                            ?>
                            <tr>
                                <td class="td" style="vertical-align:center;text-align:center;width:30%;"><?php echo $r->parameter; ?></td>
                                <?php
                                $term = get_term();
                                foreach ($term as $row):
                                    ...
                                    // print_r("L".$parameter."M");
                                    ?>
                                 <td class="td" style="vertical-align:center;text-align:center;width:40%"><?php echo $parameter; ?></td>
                                <?php
                                endforeach;
                                ?>
                            </tr>
		...
		<h3 style="margin-right: 50%;">Peer Feedback from Classmate(s)</h3>
        ...
        <table class="table-responsive scholastictable" style="width:79%;margin-left: 6%;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
			 <tr>
				 <td style="valign:top;inline-block;margin:0;padding:0;" cellpadding="0" cellspacing="0" class="term">
					<table class="" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
                        ...
                        <?php
                        $pa = get_peer_feedback_master($row1['class_id']);
                        foreach ($pa as $r):
                            ?>
                            <tr>
                                ...
                                <?php $term = get_term();
                                foreach ($term as $row):
                                    $parameter = get_published_peer_feedback_parameter_value_by_id($row1['student_id'], $r->pfm_id, $row->term_id, $academic_yr); ?>
		...
		<br>
        <h3 style="margin-right: 67%;">Parent's Feedback</h3>
        
        <table class="table-responsive " style="width:80%;margin-left: 6%;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
			 <tr>
                 <td style="valign:top;inline-block;margin:0;padding:0;" cellpadding="0" cellspacing="0" class="term">
					<table class="" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;" cellpadding="0" cellspacing="0">
		...
		<br>
		<table class="table-responsive" style="width:680px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:white;border: 0px solid red">
			
			<?php
            $date_from = getSettingsDataForAcademicYr($row1['academic_yr'])->academic_yr_from;
            $date_to = '';
            $exam_list = get_published_exams_of_a_class($row1['class_id'], $row1['section_id'], $academic_yr);
                ...
                <td style="width:100%;">
    				<table class="table-responsive" style="width:100%;margin-left: auto;margin-right: auto;border-spacing: 0px;background-color:white;border: 0;" cellpadding="0" cellspacing="0">
						<tr>
							...
							<div class="statistics_line">
							<?php
                            if (get_total_stu_attendance_till_a_month($row1['student_id'], $date_from, $date_to, $academic_yr) <> '') {
                                echo get_total_stu_attendance_till_a_month($row1['student_id'], $date_from, $date_to, $academic_yr) . '/' . get_total_workingdays_from_dailyattendance_classwise($row1['class_id'], $row1['section_id'], $date_from, $date_to, $academic_yr);
                            }
                            ?>&nbsp;</div> 
							</td>
						<?php
                        // 		$exam_list1	=	get_published_exams_of_a_class($row1['class_id'],$row1['section_id'],$row1['academic_yr']);
                        ...
                        ?>
							...
							<td style="width:20%;text-align:center;font-size:14px" ><div class="statistics_line">
								<?php
		...
		<br/>
		<table class="table-responsive" style="width:680px;margin-left:7%;margin-right: auto;border-spacing: 0px;background-color:white;border: 1px;margin-top:10%;" cellpadding="1" cellspacing="10">
			<tr>
				<td style="width:33%;">
