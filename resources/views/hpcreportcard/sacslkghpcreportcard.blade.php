...
<html>
<div class="page" style="background-image: url('https://sms.evolvu.in/public/HPC/SACS/lkghpccover.jpg');page-break-after: always;">
...
">
    ...
    ">
      ...
      @if($hasCompetency)
      <th style="border:1px solid #000; padding:8px; width:10%; text-align:center; vertical-align:middle; font-size:14px; background:#f1f2f4;">Competency</th>
      @endif
        ...
        @forelse($details as $i => $detail)
          <tr>
            @if($i === 0 && !empty($comp['competency']))
              <td style="border:1px solid #000; padding:8px;text-align:center;font-size:14px;font-weight:700; background:#f1f2f4;" rowspan="{{ $rows }}">
                {{ $comp['competency'] ?? '' }}
              </td>
            @endif
