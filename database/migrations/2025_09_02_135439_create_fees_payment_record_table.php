...
return new class extends Migration
{
    ...
    {
        Schema::create('fees_payment_record', function (Blueprint $table) {
            $table->integer('fees_payment_id')->primary();
            $table->integer('student_id')->index('idx_payment_stu');
            ...
            $table->string('academic_yr', 11)->index('idx_payment_acdyr');
        });
    }
    ...
    {
        Schema::dropIfExists('fees_payment_record');
    }
};
