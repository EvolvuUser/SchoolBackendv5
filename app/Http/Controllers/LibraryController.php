...
class LibraryController extends Controller
{
    ...
    public function locationWiseBookReport(Request $request)
    {
        try {
            ...
            $query = DB::select("SELECT a.*,b.* FROM book as a join book_copies as b on a.book_id = b.book_id where replace(a.location_of_book,' ','') LIKE replace('$location_of_book_req_val',' ','') order by b.added_date");  // where condition
