...
class Class11To12BulkReportCardDataBuilder
{
    public function build($classId, $sectionId, $academicYr, $studCount = null): array
    {
        ...
        $headerHighestMarksByExam = [];
        foreach ($examList as $exam) {
            $headerHighestMarksByExam[$exam->exam_id] = get_highestmarks_of_subject_exam_class($exam->exam_id, $classId, 42, $academicYr);
        }
        ...
        return [
            ...
            'header_highest_marks_by_exam' => $headerHighestMarksByExam,
