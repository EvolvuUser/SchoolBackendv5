...
class Class6To8BulkReportCardDataBuilder
{
    public function build($classId, $sectionId, $academicYr, $studCount = null): array
    {
        $students = collect(get_students($classId, $sectionId, $academicYr));
        ...
        foreach ($termList as $term) {
            ...
            $termMetadata[$term->term_id] = [
                ...
                'count_of_mark_headings' => $countOfMarkHeadings,
        ...
        return [
            ...
            'scholastic_table_width' => count($termList) == 1 ? '85%' : '88%',
            'date_from' => $dateFrom,
            'date_to' => $dateTo,
